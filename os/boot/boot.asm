...
;
; DESCRIPTION
;     The Boot-Sector. Pass control to LOADER.BIN in the end.
;
; HOW TO COMPILE
...
nop                     ; 这个 nop 不可少. 个人理解: 用作占位符. 相当于 python 中的 pass.
                        ; Wikipedia: x86 CPU上的NOP指令实质上是XCHG EAX, EAX（操作码同为0x90）--无任何作用的指令。
...
LABEL_EVEN:;偶数
    ...
    div     bx               ; dx:ax / BPB_BytsPerSec
                             ; ax <- 商   (FATEntry 所在的扇区相对于 FAT 来说的扇区号)
